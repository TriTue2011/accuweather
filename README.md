...
- Cảm biến `Bản tin thời tiết nguy hiểm` đọc trang [thời tiết nguy hiểm](https://www.nchmf.gov.vn/kttv/vi-VN/1/thoi-tiet-nguy-hiem-5-15.html) của Trung tâm Dự báo Khí tượng Thủy văn Quốc gia. **Trạng thái là đoạn tóm tắt nội dung** — thứ đáng đọc chứ không phải cái tiêu đề: „1. Hiện trạng bão Hồi 13 giờ ngày 25/8, vị trí tâm bão ở vào khoảng 19,4 độ Vĩ Bắc; 108,1 độ Kinh Đông… mạnh cấp 8 (62-74km/h), giật cấp 10. Di chuyển theo hướng Đông Nam, tốc độ 5-10km/h." Tiêu đề nằm ở thuộc tính `title`. Không đọc được thân bản tin thì trạng thái lùi về tiêu đề, chứ không để trống
