...
- Cảm biến `Bản tin thời tiết nguy hiểm` đọc trang [thời tiết nguy hiểm](https://www.nchmf.gov.vn/kttv/vi-VN/1/thoi-tiet-nguy-hiem-5-15.html) của Trung tâm Dự báo Khí tượng Thủy văn Quốc gia. **Trạng thái gồm tiêu đề rồi tới nội dung**, vì thiếu nửa nào cũng dở: tiêu đề không nói bão đang ở đâu, còn đoạn tóm tắt thường mở đầu bằng „1. Hiện trạng bão…" chẳng cho biết đây là tin loại gì. Ví dụ thật: „TIN BÃO TRÊN BIỂN ĐÔNG (Cơn bão số 4) — 1. Hiện trạng bão Hồi 13 giờ ngày 25/8, vị trí tâm bão ở vào khoảng 19,4 độ Vĩ Bắc; 108,1 độ Kinh Đông, trên khu vực Nam Vịnh Bắc Bộ. Sức gió mạnh nhất vùng gần tâm bão mạnh cấp 8 (62-74km/h), giật cấp 10. Di…"
- Sở dĩ nhồi cả hai vào trạng thái mà không để một nửa ở thuộc tính: Home Assistant các bản gần đây **đã bỏ khung thuộc tính khỏi hộp thoại bấm-vào-cảm-biến** — bấm vào chỉ thấy Lịch sử và Hoạt động. Thuộc tính chỉ còn xem được ở Công cụ nhà phát triển hoặc qua template, mà thứ không ai nhìn thấy thì không tính là câu trả lời. Phần vượt 255 ký tự bị cắt ở ranh giới từ, tiêu đề đứng trước nên không bao giờ mất; `title`, `summary` và `content` vẫn giữ nguyên văn bản của mình
